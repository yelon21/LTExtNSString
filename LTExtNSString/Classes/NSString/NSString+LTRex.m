...
- (BOOL)lt_isPhoneNumberString{
    ...
    /*
    移动号段：
    13[4-9]、147、15([0-2]|[7-9])、17[28]、18([2-4]|[7-8])
    联通号段：
    13[0-2]、145（上网卡）、15[56]、17[156]、18[56]
    电信号段：
    133、1349（卫星通信）、149、153、17[37]、18[019]
     */

    NSString * MOBILE = @"^1(3[0-9]|4[579]|5[0-9]|7[1235678]|8[0-9])\\d{8}$";
    
    //中国移动：China Mobile
    NSString * CM = @"^1(34[0-8]|(3[5-9]|5[0127-9]|8[2-478]|7[28])\\d)\\d{7}$";
